...
const Lcsi = () => {
  ...
  return (
    <div>
      <img className='post-cover' src={Lcsiback} alt="Lcsiback" />
      <img className='post-cover' src={lcsib} alt="lcsib" />
      <h1 className='post-hero_title'>Post-Graduation et Recherche</h1>

      <div className='post-ep1'>
        <img className='post-image' src={a} alt="a" />
        <svg className='post-image1' xmlns="http://www.w3.org/2000/svg" width="3rem" height="2em" viewBox="0 0 24 24">
        ...
        <div className='post-info'>Excellence</div> 
      </div>

      <div className='post-ep2'>
        <img className='post-image' src={a} alt="a" />
        <svg className='post-image1' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48" color="#0061B1">
          <g fill="none" stroke="#0061B1" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} color="red">
        ...
        <p className='post-info2'>Qualité <br /> méthodologique</p>
      </div>

      <div className='post-ep3'>
        <img className='post-image' src={a} alt="a" />
        <svg className='post-image1' xmlns="http://www.w3.org/2000/svg" color="#0061B1" width="1em" height="1em" viewBox="0 0 24 24">
          <path fill="currentColor" d="M13 3c3.9 0 7 3.1 7 7c0 2.8-1.6 5.2-4 6.3V21H9v-3H8c-1.1 0-2-.9-2-2v-3H4.5c-.4 0-.7-.5-.4-.8L6 9.7C6.2 5.9 9.2 3 13 3m0-2C8.4 1 4.6 4.4 4.1 8.9L2.5 11c-.6.8-.6 1.8-.2 2.6c.4.7 1 1.2 1.7 1.3V16c0 1.9 1.3 3.4 3 3.9V23h11v-5.5c2.5-1.7 4-4.4 4-7.5c0-5-4-9-9-9m-3 9c-.6 0-1-.4-1-1s.4-1 1-1s1 .4 1 1s-.4 1-1 1m3 0c-.6 0-1-.4-1-1s.4-1 1-1s1 .4 1 1s-.4 1-1 1m3 0c-.5 0-1-.4-1-1s.5-1 1-1s1 .4 1 1s-.5 1-1 1"></path>
        </svg>
        <p className='post-info2'>Pensée <br /> innovante</p>
      </div>
  ...
  <div className='appel-evenement-buttons'>
    {soutData1.map((event, index) => (
      <div key={index} className='appel-evenement'>
        <div className='appel-evenement-date'>
          <span className='post-evn-span'>{event.date.split(' ')[0]}</span>
          {event.date.split(' ')[1]} {event.date.split(' ')[2]}
        </div>
        <div className='appel-evenement-s2'>
          ...
          <div className='appel-evenement-description'>
            {event.description}
          </div>
        </div>
      </div>
