  ...
  return (
    ...
    <div className='lcsi-rect2'>
        ...
        <div className='lcsi-ep4'>
            <h1 className='lcsi-hero_title2'>2,000+</h1>
            <p className='lcsi-paragraph'>Article de recherche</p>
            <svg className='lcsi-image5' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 14 14"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M10 12.5a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 10Zm1-8.675L8.5 4L7 3.825"></path><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M7.5 9.5h1v3h-1z"></path><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M7 9.5h2"></path></svg>
        </div>
    ...
    <div className='lcsi-RECT3'>
        ...
        <div className='lcsi-box-container'>
            ...
            {getCurrentPageCards().map((product, index) => (
                <div key={index} className='lcsi-box'>
        ...
        <div className='lcsi-blog-cont'>
            {getCurrentPageCard().map((product, index) => (
                <div key={index} className='lcsi-blog'> {/* Ajout d'un div parent */}
                    ...
                    <h5 className='lcsi-blog-like'>50</h5>
                    <h5 className='lcsi-blog_vues'>12K</h5>
                    <h5 className='lcsi-blog_temps'>15 min ago</h5>
                    <h5 className='lcsi-blog_more'>Read More...</h5>
